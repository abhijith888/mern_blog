...
export default function DashProfile() {
  ...
  const  [imageFileUploadProgress , setImageFileUplaodProgress] = useState(0);
        ...
        <Modal show={showModal} onClose={()=>setShowModal(false)} popup size='md'>
          ...
          <Modal.Body>
            <div className='text-center'>
              <HiOutlineExclamationCircle className='h-14 w-14 text-gray-400 dark:test-gray-200 mb-4 mx-auto'/>
